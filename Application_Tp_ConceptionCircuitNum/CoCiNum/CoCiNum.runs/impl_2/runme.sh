...
HD_PWD='C:/Users/user/Downloads/CoCiNum/vivado/CoCiNum_LIADI_TRAORE/CoCiNum_LIADI_TRAORE.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log MicrowaveTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicrowaveTop.tcl -notrace
