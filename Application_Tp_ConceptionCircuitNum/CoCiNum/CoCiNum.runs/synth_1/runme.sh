...
HD_PWD='C:/Users/user/Downloads/CoCiNum/vivado/CoCiNum_LIADI_TRAORE/CoCiNum_LIADI_TRAORE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log taptop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source taptop.tcl
