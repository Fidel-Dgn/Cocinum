...
HD_PWD='C:/Users/user/Downloads/CoCiNum/vivado/CoCiNum_LIADI_TRAORE/CoCiNum_LIADI_TRAORE.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log MicrowaveTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicrowaveTop.tcl
